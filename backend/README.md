...
## Project Structure
    ...
    ├── appwithconnectors_d_60849  # Django project configurations
...
1. Clone this repo and `cd appwithconnectors_d_60849`
...
2. Clone this repo and `cd appwithconnectors_d_60849`
